...
public class Technician {
    ...
    public Technician(String surname) {
        this.name = surname;
        System.out.println("22222");
    }   
    
    public Technician(String surname, int birth) {
        this.surname = surname;
        this.birth = birth;
        System.out.println("33333");
    }
    
    public Technician(String name, String surname, long IDNP) {
        this.name = name;
        this.surname = surname;
        this.IDNP = IDNP;
    ...
    public Technician(String street, int blockNo, int apartmentNo) {
        this.street = street;
